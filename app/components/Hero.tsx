...
export default function Hero() {
  return (
    <section id="top" className="border-b border-line dark:border-line-dark mx-6">
      <div className="container-xw grid gap-12 py-16 md:py-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        <div>
          ...
          <p className="mt-6 max-w-md text-lg text-steel leading-relaxed">
            NOVA pairs your existing cameras with our detection models that flag
            what a person watching twelve feeds at once would miss. Built to compensate for human limitations in high risk environments.
          </p>
        ...
        <div className="relative">
          <div className="rounded-lg border border-line dark:border-line-dark bg-paper-raised dark:bg-ink-raised overflow-hidden">
            <div className="flex items-center justify-between border-b border-line dark:border-line-dark px-4 py-2.5">
              <span className="font-mono text-xs text-steel">Warehouse 4</span>
              <span className="flex items-center font-mono text-xs text-signal text-red-600">
                <span>
                <Dot size={16} className="text-signal" />
                </span>
